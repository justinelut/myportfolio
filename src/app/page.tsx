...
export const metadata: Metadata = {
  ...
  description:
    "Hi there! I'm Justine G, a passionate web developer specializing in React, Next.js, and Tailwind CSS. Check out my work and get to know my journey in web development.",
  keywords:
