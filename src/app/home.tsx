        ...
        <div className="items-center flex flex-col justify-center px-16 pt-10 max-md:px-5">
          <div className="flex w-full max-w-[960px] flex-col mt-6 mb-10 items-start max-md:max-w-full max-md:mb-10">
            ...
            <div className="flex lg:flex-row flex-col lg:justify-start gap-x-10 items-center">
              <Link
                href={"/intro"}
                className="items-center w-[100%] w-full text-xl mt-10 px-8 py-4 dark:bg-white rounded-full dark:text-black text-white font-extrabold bg-orange-600 grow flex gap-4"
              >
                <span>About me</span>
                <span>
                  <ArrowRight />
              ...
              <Link
                ...
                className="items-center text-xl mt-10 px-8 py-4 rounded-full  text-white font-extrabold bg-orange-600 grow flex gap-4"
              >
                <span>Resume</span>
                <ArrowUpRight />
              </Link>
